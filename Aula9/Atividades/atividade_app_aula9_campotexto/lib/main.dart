  ...
  Widget build(BuildContext context) {
    ...
    return Column(
     ...
     TextField(
      ...
      color: const Color.fromARGB(255, 0, 90, 63),child: Text("${email.text}",
      ...
      Container(width: 300,height: 50,
      color: const Color.fromARGB(255, 0, 90, 63),child: Text("${nome.text} - ${idade.text}",
      textAlign: TextAlign.center,
      ...
      Container(width: 300,height: 50,
      color: const Color.fromARGB(255, 0, 90, 63),child: Text("${nome.text} - ${numero.text}",
      textAlign: TextAlign.center,
      ...
      Container(width: 300,height: 50,
      color: const Color.fromARGB(255, 0, 90, 63),child: Text("${nome.text} - ${cidade.text}",
      textAlign: TextAlign.center,
      ...
      Container(width: 300,height: 50,
      color: const Color.fromARGB(255, 0, 90, 63),child: Text("${nome.text} - ${estado.text}",
      textAlign: TextAlign.center,
